...
export default function PostCard({ post }: Props) {
  return (
    <article className="group border border-gray-200 dark:border-gray-800 rounded-xl p-6 hover:border-accent-300 dark:hover:border-accent-700 hover:shadow-md dark:hover:shadow-accent-900/20 transition-all duration-200">
