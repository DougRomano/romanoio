...
I started in the VB6 days. Drag a button onto a form, double-click it, write some code, hit F5. It felt like the future. The WYSIWYG era made you feel like software development would only get easier from here. I wrote about that arc — and what nine months of going all-in on agentic development actually looks like — in [Nine Months in the Trenches](/posts/nine-months-in-the-trenches). The JetBrains cancellation is one data point in a much longer story.
...
I haven't manually typed code in months — I wrote about what that actually looks like day-to-day in [I Haven't Typed Code in Months. I've Never Shipped More.](/posts/i-havent-typed-code-in-months) But I'm directly responsible for more shipped code per month than at any point in my career. The velocity, the documentation quality, and the test coverage are all higher than when I was doing it by hand in a $250/year IDE.
