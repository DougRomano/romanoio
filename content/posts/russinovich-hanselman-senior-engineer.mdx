...
I wrote about this from a different angle a few months ago, in [Nine Months in the Trenches of Agentic Development](/posts/nine-months-in-the-trenches). Nine months of going all-in tells you things that a peer-reviewed paper can only approximate from the outside.
...
Your LinkedIn title still says Senior Engineer or Solutions Architect or Technical Lead. But the implicit contract behind it — what distinguishes you from a competent junior with a good AI setup — has shifted. The teams that haven't figured this out yet are the ones [still running two-week sprints and wondering why their AI features aren't moving any needles](/posts/two-week-sprints-killing-ai-strategy). And the individual engineers who are genuinely compounding their judgment rather than just generating more code? I described what that actually looks like day-to-day in [I Haven't Typed Code in Months. I've Never Shipped More.](/posts/i-havent-typed-code-in-months).
