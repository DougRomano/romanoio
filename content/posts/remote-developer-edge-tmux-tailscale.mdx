...
This is the challenge I ran into building the Claude Winforms Conversion Agent, a suite of 10 specialized TypeScript agents designed to systematically analyze and convert legacy VB.NET Windows Forms applications into modern ASP.NET Core MVC architecture. If you want the backstory on how I got to building something like this, [Nine Months in the Trenches of Agentic Development](/blog/nine-months-in-the-trenches) covers the learning curve, what I got wrong the first two months, and what eventually stuck. The orchestrator runs agents sequentially, each one building on the last, processing thousands of lines of legacy code across forms, business objects, data access layers, and security patterns. A full entity conversion can take a meaningful chunk of time to run.
...
There's a philosophical shift happening in how we develop software. AI agents are doing the tedious extraction work: parsing legacy code, mapping UI components, generating boilerplate. But they still need humans in the loop: to kick them off, to review their output, to guide the interactive generation steps. I've written about both sides of that shift: [I Haven't Typed Code in Months](/blog/i-havent-typed-code-in-months) on what the day-to-day actually looks like when you're deep in it, and [Building Software with AI Is Addictive](/blog/building-with-ai-is-addictive) on why you can't stop — which is exactly why the remote monitoring setup matters. When the agents work while you live your life, the addiction becomes sustainable.
