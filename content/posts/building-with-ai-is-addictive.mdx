...
But the tool also removed the friction that used to force me to stop. And I'm being honest with myself that I haven't replaced it with anything yet. The natural governor (that building was slow) kept me in balance. Now that governor is gone, and I'm still figuring out where the new boundaries are.
