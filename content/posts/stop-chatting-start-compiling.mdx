...
tags: ["AI", "Agentic Development", "Anthropic", ".NET", "Software Architecture", "Claude Code", "Developer Productivity"]
---
...
This is what separates developers who are using AI tools from developers who are engineering with them. The chat loop feels natural. It's the first thing everyone builds. But it's the training wheels. The compiled approach is where the real advantage lives.
