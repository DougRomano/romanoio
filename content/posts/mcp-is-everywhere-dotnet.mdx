...
I want to tell you about something I've been building for the last six to nine months, because it illustrates both how powerful agents already are and how much more powerful they'd be with MCP. The full context for how I got to building production agentic systems is in [Nine Months in the Trenches of Agentic Development](/blog/nine-months-in-the-trenches) — this section describes where that work led.
...
The content gap problem isn't new in the .NET AI ecosystem. I wrote about a closely related one — that most AI training data is low-quality open source and tutorial code — in [Most of the Code AI Learned From Is Garbage](/blog/most-code-ai-learned-from-is-garbage). The implication for MCP is the same: if the content that exists is thin, the models will produce thin MCP implementations. Better community content isn't just good for developers learning; it raises the baseline for what AI agents produce when asked to build MCP servers in C#.
