...
export const metadata: Metadata = {
  title: 'About',
  description: 'About Doug Romano — AI-first developer and software architect.',
};
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
      <div className="max-w-2xl">
        ...
        <div className="prose prose-gray dark:prose-invert prose-a:text-accent-600 dark:prose-a:text-accent-400">
          ...
          <p>
            This blog is where I document what that transition looks like in the real world.
            Not demos. Not two-minute clips. The actual patterns, the actual failures, and the
            things I wish someone had written down before I learned them the hard way.
          </p>

          <h2>What I write about</h2>
          <p>
            The focus here is AI-first software development — with enough .NET and architecture
            context to keep it grounded in real production systems:
          </p>
          <ul>
            <li>Agentic development workflows and Claude Code in practice</li>
            <li>MCP servers, tool calling, and building real AI agents</li>
            <li>What AI does well, where it fails, and how to steer it</li>
            <li>.NET and C# as a foundation — patterns, architecture, SQL Server</li>
            <li>How traditional engineering disciplines apply (and don&apos;t) in the AI era</li>
          </ul>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            <em>
              The opinions expressed on this site are my own and do not represent the views
              of my employer, clients, or any organization I am affiliated with.
            </em>
          </p>
        </div>
